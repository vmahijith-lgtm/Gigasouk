...
import {
  adminListOrders, adminPendingVariants,
...
// ════════════════════════════════════════════════════════════════
export default function GigaSoukAdminPanel({ adminId, onSignOut }) {
  // ════════════════════════════════════════════════════════════════
  ...
  return (
    <div style={{
      ...
      {actionMsg.text && (
        <div style={{
          background: (msgColor[actionMsg.type] || C.green) + "18",
        ...
        {TABS.map(t => (
          <button key={t.key} onClick={() => setTab(t.key)}
            ...
            {t.key === "variants" && variants.length > 0 &&
              <span style={{
                marginLeft: 5, background: C.gold + "33", color: C.gold,
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 4 }}>
                    <span style={{
                      background: (STATUS_COLOR[o.status] || C.t3) + "22",
      ...
      {!loading && tab === "payments" && (
        <div>
          ...
          {orders.filter(o => o.payment_status === "in_escrow").map(o => (
            <div key={o.id} style={{
              background: C.card, border: `1px solid ${C.blue}44`,
              borderRadius: 10, padding: "14px 18px", marginBottom: 10,
              display: "flex", justifyContent: "space-between", alignItems: "center"
            }}>
              <div>
